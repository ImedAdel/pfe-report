...
\begin{toexclude}
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}[scale=0.5, every node/.append style={transform shape}]
			\umlclass[x=-4,draw=none,rounded corners]{User}{
				ID : UUID \\
				Name : Text \\
				Email : Text \\
				Avatar : Text \\
			...
			\umlclass[left=10cm of User,draw=none,rounded corners]{Space}{
				ID : UUID \\
				Name : Text \\
				Handle : Text \\
				CreatedAt: Timestamptz \\
			...
			\umlclass[below left=4cm and 2cm of Space,draw=none,rounded corners]{Project}{
				ID : UUID \\
				Name : Text \\
				Icon : Text \\
				Description : Text \\
			...
			\umlclass[left=4cm of Project,draw=none,rounded corners]{Member}{
				UserID : UUID \\
				SpaceID : UUID \\
			...
			\umlclass[right=3cm of Project,draw=none,rounded corners]{Confirmation}{
				UserID : UUID \\
				SpaceID : UUID \\
				Token: Text \\
				CreatedAt: Timestamptz \\
			...
			\umlclass[right=3cm of Confirmation,draw=none,rounded corners]{AccessToken}{
				ID : UUID \\
				Token : Text \\
				Name : Text \\
				Resource : Text \\
			...
			\umlclass[below=2cm of Project,draw=none,rounded corners]{Collection}{
				ID : UUID \\
				Name : Text \\
				Icon : Text \\
				Description : Text \\
			...
			\umlclass[below=2cm of Collection,draw=none,rounded corners]{Field}{
				ID : UUID \\
				Name : Text \\
				Icon : Text \\
				Description : Text \\
			...
			\umlclass[right=4cm of Field,draw=none,rounded corners]{Document}{
				ID : UUID \\
				Version: Integer \\
				CollectionID: UUID \\
				CreatedAt: Timestamptz \\
			...
			\umlclass[left=4cm of Field,draw=none,rounded corners]{View}{
				ID : UUID \\
				Name : Text \\
				Type : Text \\
				Data : Text \\
			...
			\umlclass[below=2cm of Document,draw=none,rounded corners]{Block}{
				ID : UUID \\
				Data : Text \\
				ParentID : UUID \\
				Version: Integer \\
			...
			\umlclass[below=1.5cm of AccessToken, type=enumeration,draw=none,rounded corners]{AccessLevel}{
				Owner \\
				Admin \\
				ReadWrite \\
				ReadOnly
...
\subsubsection{"X" sequence diagram}
