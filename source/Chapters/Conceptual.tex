...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=0.5, every node/.append style={transform shape}]
		...
		\umlclass[left=10cm of User]{Space}{
			ID : UUID \\
			Name : Text \\
			Handle : Text \\
			CreatedAt: Timestamptz \\
		...
		\umlclass[below left=4cm and 2cm of Space]{Project}{
			ID : UUID \\
			Name : Text \\
			Icon : Text \\
			Description : Text \\
		...
		\umlclass[left=4cm of Project]{Member}{
			UserID : UUID \\
			SpaceID : UUID \\
		...
		\umlclass[right=3cm of Project]{Confirmation}{
			UserID : UUID \\
			SpaceID : UUID \\
			Token: Text \\
			CreatedAt: Timestamptz \\
		...
		\umlclass[right=3cm of Confirmation]{AccessToken}{
			ID : UUID \\
			Token : Text \\
			Name : Text \\
			Resource : Text \\
		...
		\umlclass[below=2cm of Project]{Collection}{
			ID : UUID \\
			Name : Text \\
			Icon : Text \\
			Description : Text \\
		...
		\umlclass[below=2cm of Collection]{Field}{
			ID : UUID \\
			Name : Text \\
			Icon : Text \\
			Description : Text \\
		...
		\umlclass[right=4cm of Field]{Document}{
			ID : UUID \\
			Version: Integer \\
			CollectionID: UUID \\
			CreatedAt: Timestamptz \\
		...
		\umlclass[left=4cm of Field]{View}{
			ID : UUID \\
			Name : Text \\
			Type : Text \\
			Data : Text \\
		...
		\umlclass[below=2cm of Document]{Block}{
			ID : UUID \\
			Data : Text \\
			ParentID : UUID \\
			Version: Integer \\
		...
		\umlclass[below=1.5cm of AccessToken, type=enumeration]{AccessLevel}{
			Owner \\
			Admin \\
			ReadWrite \\
			ReadOnly
