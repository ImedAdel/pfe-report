...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=0.5, every node/.append style={transform shape}]
		...
		\umlclass[left=10cm of User,draw=none]{Space}{
			ID : UUID \\
			Name : Text \\
			Handle : Text \\
			CreatedAt: Timestamptz \\
		...
		\umlclass[below left=4cm and 2cm of Space,draw=none]{Project}{
			ID : UUID \\
			Name : Text \\
			Icon : Text \\
			Description : Text \\
		...
		\umlclass[below=2cm of Project,draw=none]{Collection}{
			ID : UUID \\
			Name : Text \\
			Icon : Text \\
			Description : Text \\
		...
		\umlclass[right=4cm of Field,draw=none]{Document}{
			ID : UUID \\
			Version: Integer \\
			CollectionID: UUID \\
			CreatedAt: Timestamptz \\
		...
		\umlclass[left=4cm of Field,draw=none]{View}{
			ID : UUID \\
			Name : Text \\
			Type : Text \\
			Data : Text \\
		...
		\umluniassoc[geometry=-|-, weight=0.3, arg1=x, mult1=1, pos1=1.9, arg2=y, mult2=*, pos2=0.2]{Member}{User}
		\umluniassoc[geometry=|-, arg1=x, mult1=1, pos1=1.9, arg2=y, mult2=*, pos2=0.2]{Member}{Space}

		\umluniassoc[geometry=|-|, arg1=x, mult1=1, pos1=0.9, arg2=SpaceID, mult2=*, pos2=0.2]{Project}{Space}
		\umluniassoc[geometry=|-, arg1=x, mult1=1, pos1=0.9, arg2=CreatedBy, mult2=*, pos2=0.2]{Project}{User}
		\umluniassoc[geometry=-|-, arg1=x, mult1=1, pos1=1.9, arg2=ModifiedBy, mult2=*, pos2=0.2]{Project}{User}

		\umluniassoc[geometry=-|-, arg1=x, mult1=1, pos1=1.9, arg2=y, mult2=*, pos2=0.2]{Confirmation}{User}

		\umluniassoc[geometry=|-, arg1=x, mult1=1, pos1=1.9, arg2=y, mult2=*, pos2=0.2]{AccessToken}{User}

		\umluniassoc[geometry=--, arg1=x, mult1=1, pos1=0.9, arg2=ProjectID, mult2=*, pos2=0.2]{Collection}{Project}
		\umluniassoc[geometry=-|-, arg1=x, mult1=1, pos1=0.9, arg2=CreatedBy, mult2=*, pos2=0.2]{Collection}{User}
		\umluniassoc[geometry=-|-, arg1=x, mult1=1, pos1=1.9, arg2=ModifiedBy, mult2=*, pos2=0.2]{Collection}{User}

		\umluniassoc[geometry=-|-, arg1=x, mult1=1, pos1=0.9, arg2=CollectionID, mult2=*, pos2=0.2]{View}{Collection}

		\umluniassoc[geometry=|-|, arg1=x, mult1=1, pos1=0.9, arg2=CollectionID, mult2=*, pos2=0.2]{Field}{Collection}

		\umluniassoc[geometry=-|-, arg1=x, mult1=1, pos1=0.9, arg2=CollectionID, mult2=*, pos2=0.2]{Document}{Collection}
		\umluniassoc[geometry=-|, arg1=x, mult1=1, pos1=0.9, arg2=CreatedBy, mult2=*, pos2=0.2]{Document}{User}
		\umluniassoc[geometry=-|, arg1=x, mult1=1, pos1=1.9, arg2=ModifiedBy, mult2=*, pos2=0.2]{Document}{User}

		\umluniassoc[geometry=|-|, arg1=x, mult1=1, pos1=0.9, arg2=DocumentID, mult2=*, pos2=0.2]{Block}{Document}
		\umluniassoc[geometry=|-|, arg1=x, mult1=1, pos1=0.9, arg2=FieldID, mult2=*, pos2=0.2]{Block}{Field}
		\umluniassoc[arg1=x, mult1=1, pos1=0.9, arg2=ParentID, mult2=*, pos2=0.2,loopsize=6cm]{Block}{Block}
		\umluniassoc[geometry=-|, arg1=x, mult1=1, pos1=0.9, arg2=CreatedBy, mult2=*, pos2=0.2,arm1=3cm]{Block}{User}
		\umluniassoc[geometry=-|, arg1=x, mult1=1, pos1=1.9, arg2=ModifiedBy, mult2=*, pos2=0.2,arm1=4cm]{Block}{User}
...
\begin{sdfig}{Sign up}{sign up}{sign-up}
	...
	\umlobject[no ddots,draw=none]{Client}
...
\begin{sdfig}{Log in}{log in}{log-in}
	...
	\begin{umlcall}[op={Log in}]{Visitor}{Client}
		\begin{umlcall}[op={Validate}]{Client}{Client}
			\begin{umlfragment}[type=alt, label=valid]
				\begin{umlcall}[type=return,op={Loading}]{Client}{Visitor}
					\begin{umlcall}[op={Log in}]{Client}{Server}
						\begin{umlcall}[op={Has user}]{Server}{Database}
							\begin{umlfragment}[type=alt, label=true]
								\begin{umlcall}[type=return,op={Yes}]{Database}{Server}
									\begin{umlcall}[op={Create OTP}]{Server}{Database}
...
\begin{sdfig}{Create collection}{create collection}{create-collection}[1][H]
	...
	\begin{seqdigauth}[Editor]
		\begin{umlcall}[op={Create collection},return=Ok]{Editor}{Client}
			\begin{umlcall}[op={Create collection},return=Ok]{Client}{Server}
				\begin{umlcall}[op={Create collection}]{Server}{Database}
					\begin{umlcall}[op={Create field}]{Server}{Database}
					\end{umlcall}
					\begin{umlcall}[op={Create view}]{Server}{Database}
...
\begin{sdfig}{Create field}{create field}{create-field}[1][H]
	...
	\begin{seqdigauth}[Editor]
		\begin{umlcall}[op={Create field},return={Select type}]{Editor}{Client}
		\end{umlcall}

		\begin{umlcall}[op={Select type},return=Ok]{Editor}{Client}
			\begin{umlcall}[op={Update local state}]{Client}{Client}
			\end{umlcall}
			\begin{umlcall}[op={Create field},return=Ok]{Client}{Server}
				\begin{umlcall}[op={Create field}]{Server}{Database}
...
\begin{sdfig}{Update block}{update block}{update-block}
	...
	\begin{seqdigauth}[Editor]
		\begin{umlcall}[op={Update block},return={Select type}]{Editor}{Client}
		\end{umlcall}

		\begin{umlcall}[op={Update block}]{Editor}{Client}
			\begin{umlcall}[op={Update local state}]{Client}{Client}
			\end{umlcall}
			\begin{umlcall}[op={Update block}]{Client}{Server}
				\begin{umlcall}[op={Get block}]{Server}{Database}
					\begin{umlcall}[op={Compare versions}]{Server}{Server}
						\begin{umlfragment}[type=alt, label=equal]
							...
							\end{umlcall}
							\umlfpart[else]
							\begin{umlcall}[op={Refuse change},type=return]{Server}{Client}
								\begin{umlcall}[op={Update local state}]{Client}{Client}
								\end{umlcall}
							\end{umlcall}
						\end{umlfragment}
